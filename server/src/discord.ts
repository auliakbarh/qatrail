...
const LABELS: Record<string, string> = {
  ...
  approveTestCaseRequest: "Test case change approved",
  approveTestCaseRequests: "Test case changes approved (bulk)",
  rejectTestCaseRequest: "Test case change rejected",
