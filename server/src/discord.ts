...
const LABELS: Record<string, string> = {
  ...
  issueStartReview: "Issue retest started",
  ...
  submitAppTestReview: "App test report sent for review",
  reviewAppTest: "App test report reviewed",
  submitSessionTestReview: "Session report sent for review",
  reviewSessionTest: "Session report reviewed",
