...
export const SETTING = gql`
  query Setting {
    setting { maintenanceMode maintenanceMessage discordEnabled discordWebhookUrl }
  }
`;
export const UPDATE_SETTING = gql`
  mutation UpdateSetting($input: SettingInput!) {
    updateSetting(input: $input) { maintenanceMode maintenanceMessage discordEnabled discordWebhookUrl }
  }
`;
